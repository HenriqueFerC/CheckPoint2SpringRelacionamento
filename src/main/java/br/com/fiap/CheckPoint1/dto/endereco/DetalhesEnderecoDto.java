...
public record DetalhesEnderecoDto(Long id, String pais, String estado, String cidade, String logradouro, String cep, String bairro, DetalhesFuncionarioDto detalhesDto) {
